...
export const deletePost = (postId: string) => sendDelete(`/posts/${postId}/delete`);
...
export const deletePostComment = (postId: string, commentId: string) => sendDelete(`/posts/${postId}/comment/${commentId}/delete`);